...
function Remove-DeviceDeploymentTempData {
	...
	process {
		try {
			...
			Get-ChildItem -Path $dependencyDirectory -Directory | Where-Object {$_.Name -in $dependencies} | Remove-Item -Force -Recurse -Confirm:$false -WhatIf:$WhatIfPreference -Verbose:$VerbosePreference
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD02NU5oEcEM0qc
# EHzYpAa0ZwztOGOHclJt+V0yIwy6xKCCDJ0wggXxMIIE2aADAgECAhM2AAAABHxF
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgCQhCqmg6eugkaJx2oXKR/5cJ
# klGx/LMVw8AHQNRYl9cwDQYJKoZIhvcNAQEBBQAEggEAC95or0mCr642AQGoZQ+4
# 49rGVN/zCMmxbvkMrFdZAcylfAZiuovfwzE1b23jD3kCP2+uhVefmklL3mQMZHGs
# jiMBgFujEE8ZS+rxU7vOSJiISw4JP6WyILsRqJssWOikScH/j8wl03/j9VP3quKh
# kPvn5ZZiflFL9deAIaXJAVG4HHUS0o4oO30IxkttVtWKqp+j6Nt3AxnWG0GjYWtN
# 0d7MzyjN1wIbmFT2kAHkdLRcdEFYtgh5H0nXP6cYIm4Vjj3A7jlK4Vsy37o8EM7D
# Gpd39uhiYOg9nRrbNRc0uA2CBenCW3k78UoKoVMeGeG/ZoGn7UmHbRFtjJr1pTWG
# mw==
