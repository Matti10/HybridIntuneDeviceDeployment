...
#>
function Register-BuildProcessElevatedCredentailsScriptWide {
	...
	process {
		try {
				if ($null -eq $Credential) {
					$Credential = Get-BuildProcessElevatedCredentials -WhatIf:$WhatIfPreference -Verbose:$VerbosePreference
				}
				$Script:ADElevatedCredential = $Credential
		}
